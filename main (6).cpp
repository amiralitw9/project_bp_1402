                                ...
                                while (!quit) {
                                    ...
                                    while (SDL_PollEvent(&e) != 0) {
                                        ...
                                        if (e.type == SDL_MOUSEWHEEL) {
                                            if (e.wheel.x > 0 && volume < 128) {
                                                volume += 4; // Scroll right

                                            } else if (e.wheel.x < 0 && volume > 0) {
...
//                            if(true){}//شرط بعدی
                            ...
                            if (mouseX >= p.x[1] && mouseX <= p.x[1] + (width / 3) && mouseY >= p.y[10] &&
                                mouseY <= p.y[10] + (height / 9)) {}//تصویر سازندگان بازی
                            if (exit &&
